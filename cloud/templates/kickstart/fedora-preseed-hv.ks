install
url --url http://129.102.1.37/pub/fedora/linux/releases/32/Server/x86_64/os/
repo --name="BaseOS" --baseurl=http://129.102.1.37/pub/fedora/linux/releases/32/Server/x86_64/os/
